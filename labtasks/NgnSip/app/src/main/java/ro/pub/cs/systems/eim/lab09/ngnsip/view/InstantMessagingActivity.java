...
public class InstantMessagingActivity extends AppCompatActivity {
    ...
    private final SendButtonClickListener sendButtonClickListener = new SendButtonClickListener();
        ...
        public void onClick(View view) {
            if (VoiceCallActivity.getInstance().getNgnSipService() != null) {
                ...
                if (!instantMessagingSession.sendTextMessage(messageEditText.getText().toString())) {
                    ...
                    conversationTextView.setText(String.format("%sMe: %s\n", conversation, messageEditText.getText().toString()));
    ...
    protected void onDestroy() {
        ...
        disableInstantMessagingBroadcastReceiver();
        super.onDestroy();
    }
